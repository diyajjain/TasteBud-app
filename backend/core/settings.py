...
MIDDLEWARE = [
    ...
    # 'whitenoise.middleware.WhiteNoiseMiddleware',  # Temporarily commented out for deployment
...
# Static files configuration for production (temporarily commented out)
